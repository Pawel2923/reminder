...
CREATE TABLE `archive` (
  ...
  CONSTRAINT `archive_ibfk_1` FOREIGN KEY (`users_id`) REFERENCES `users` (`uid`)
...
CREATE TABLE `bin` (
  ...
  PRIMARY KEY (`uid`),
  KEY `users_id` (`users_id`),
  CONSTRAINT `bin_ibfk_1` FOREIGN KEY (`users_id`) REFERENCES `users` (`uid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-09-16 10:20:14
